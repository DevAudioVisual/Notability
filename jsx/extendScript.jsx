...
function limpaCelulas() {
    var batContent2 = 'node "C:\\Program Files (x86)\\Common Files\\Adobe\\CEP\\extensions\\Notability\\js\\limpa-json.js"';
...
markerNaTL: function() {
  #include ./filterClass.jsx
    ...
    readJSONFile(File("C:/Program Files (x86)/Common Files/Adobe/CEP/extensions/Notability/js/cleaned_data.json"));
    separarIguais(aula);
    separaUpdateLista();
    tempoMarker(); 
